...
'''build the root of the first page in the application'''
root=Tk()
root.title('Sign in')
...
def admins():
    ...
    if username=='admin' and password=='123456':
        ...
        '''these functions are for each of the tools were we call each pipeline'''
        def NMF():
            NM.main(screen)
